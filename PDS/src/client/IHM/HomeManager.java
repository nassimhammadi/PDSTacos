...
public class HomeManager extends JFrame{
	...
	public HomeManager(Client cli, int id_client){
		...
		panelWest1.add(new JLabel("Identifiant du v�hicule :"));
		...
		panelWest2.add(new JLabel("Ann�e du v�hicule :"));
		...
		panelWest2.add(new JLabel("Mod�le :"));
		model_up = new JTextField();
		panelWest2.add(model_up);
		panelWest2.add(new JLabel("Pr�sence dans le d�p�t :"));
		...
		panelEast1.setBorder(new TitledBorder("Supprimer un v�hicule de la base : "));
		panelEast1.add(new JLabel("Identifiant du v�hicule :"));
		...
		panelEast2.add(new JLabel("Ann�e du v�hicule :"));
		...
		panelEast2.add(new JLabel("Mod�le :"));
		...
		panelSouth.setBorder(new TitledBorder("Informations sur le v�hicule : "));
		...
		present = new JRadioButton("Pr�sent dans le d�p�t");
		...
		southLeft.add(Box.createGlue());
		southLeft.add(new JLabel("Type de v�hicule : "));
		type = new JLabel();
		southLeft.add(type);


		southLeft.add(Box.createGlue());
		southLeft.add(new JLabel("Ann�e de mise en circulation : "));
		yearv = new JLabel();
		southLeft.add(yearv);
		...
		southLeft.add(Box.createGlue());
		southLeft.add(new JLabel("Mod�le : "));
		model = new JLabel();
		southLeft.add(model);
		...
		jsp.setBorder(new TitledBorder("Historique des r�parations : "));
			...
			while (!fin){
				if(!rep.equals(c.getCcs().getLastMessageFromServeur())){
					...
					if (c.getCcs().getLastMessageFromServeur().equals("update")){
						...
						d2.showMessageDialog(jf, "V�hicule mis � jour");
						fin=true;
						...
						if(strings.length == 1){
							...
							d.showMessageDialog(jf, "V�hicule non trouv�");
							fin = true; 
							break;
						}
						else{
							...
							else type.setText("V�lo");
						}
						fin = true;
					}
					else if (part1.equals("insert")){
						JOptionPane d3 = new JOptionPane();
						d3.showMessageDialog(jf, "V�hicule ins�r�");
						fin = true;
						southRight.removeAll();
						...
						JOptionPane d3 = new JOptionPane();
						d3.showMessageDialog(jf, "V�hicule supprim�");
						fin = true;
						southRight.removeAll();
						displayAllVehicle();
					}
